...
const defaultChainStore = defaultEvmStores;

export { Web3, chains as allChainsData, chainData, chainId, connected, createStore, defaultChainStore, defaultEvmStores, evmProviderType, getChainStore, loadWeb3, makeContractStore, makeEvmStores, selectedAccount, walletType, web3 };
