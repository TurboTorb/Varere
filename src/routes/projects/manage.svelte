<script>
    ...
    let scripts = [
        "/assets/js/demo/page-scrum-board.demo.js"
    ];    
...
<div id="content" class="app-content">
    ...
    <div class="mb-md-4 mb-3 d-md-flex">
        <div class="dropdown-toggle">
            <a href="#hud" data-bs-toggle="dropdown" class="text-white text-opacity-75 text-decoration-none"><i class="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/hud</a>
            <div class="dropdown-menu">
                <a href="#mobile" class="dropdown-item"><i class="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/mobile-app-dev</a>
                <a href="#bootstrap" class="dropdown-item"><i class="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/bootstrap-5</a>
                <a href="#mvc" class="dropdown-item"><i class="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/mvc-version</a>
                <a href="#ruby" class="dropdown-item"><i class="far fa-folder fa-fw fa-lg text-theme me-1"></i> project/ruby-version</a>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-6">
            ...
            <div class="card mb-3">
                ...
                <div class="card-header d-flex align-items-center bg-white bg-opacity-15">
                    ...
                    <a href="#redo" class="text-white text-opacity-50 text-decoration-none me-3"><i class="fa fa-fw fa-redo"></i></a>
                    <a href="#trash" class="text-white text-opacity-50 text-decoration-none"><i class="fa fa-fw fa-trash"></i></a>
                </div>
                <!-- END card-header -->
                <!-- BEGIN list-group -->
                <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item d-flex px-3">
                        ...
                        <div class="flex-fill">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <a href="#todo" class="text-white text-opacity-50" data-bs-toggle="collapse" data-bs-target="#todoBoard">
                    ...
                    <!-- END list-group-item -->
                    <!-- BEGIN list-group-item -->
                    <a href="#show" class="list-group-item list-group-item-action d-flex ps-3">
                        <div class="me-3 pt-1">
                            <i class="far fa-question-circle text-white text-opacity-50 fa-fw fa-lg"></i> 
                        </div>
                        <div class="flex-fill">
                    ...
                    <!-- END list-group-item -->
                    <!-- BEGIN list-group-item -->
                    <a href="#form" class="list-group-item list-group-item-action d-flex ps-3">
                        <div class="me-3 pt-1">
                            <i class="far fa-question-circle text-white text-opacity-50 fa-fw fa-lg"></i> 
                        </div>
                        <div class="flex-fill">
                    ...
                    <!-- END list-group-item -->
                    <!-- BEGIN list-group-item -->
                    <a href="#issue" class="list-group-item list-group-item-action d-flex ps-3">
                        <div class="me-3 pt-1">
                            <i class="far fa-question-circle text-white text-opacity-50 fa-fw fa-lg"></i> 
                        </div>
                        <div class="flex-fill">
                    ...
                    <!-- END list-group-item -->
                    <!-- BEGIN list-group-item -->
                    <a href="#announcement" class="list-group-item list-group-item-action d-flex ps-3">
                        <div class="me-3 pt-1">
                            <i class="far fa-question-circle text-white text-opacity-50 fa-fw fa-lg"></i> 
                        </div>
                        <div class="flex-fill">
                    ...
                    <div class="list-group-item d-flex px-3">
                        ...
                        <div class="flex-fill">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <a href="#progress" class="text-white text-opacity-50" data-bs-toggle="collapse" data-bs-target="#inProgressBoard">
                                        <i class="fa fa-plus-circle"></i>
                                    </a>
                                </div>
                                <div class="progress progress-xs w-100px me-2 ms-auto" style="height: 6px;">
                            ...
                            <div class="form-group mb-1">
                                <div class="collapse show" id="inProgressBoard">
                                    <div class="form-check mb-2px">
                                        ...
                                        <label class="form-check-label small" for="customCheck4">check all browser compatibility for HTML5 flexbox</label>
                                    </div>
                                    <div class="form-check mb-2px">
                                        <input type="checkbox" class="form-check-input" id="customCheck5" />
                                        <label class="form-check-label small" for="customCheck5">fallback integration by using other display property</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item d-flex px-3">
                        ...
                        <div class="flex-fill">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <a href="#add" class="text-white text-opacity-50" data-bs-toggle="collapse" data-bs-target="#inProgress2Board">
                                        <i class="fa fa-plus-circle"></i>
                                    </a>
                                </div>
                                <div class="progress progress-xs w-100px me-2 ms-auto" style="height: 6px;">
                            ...
                            <div class="form-group mb-1">
                                <div class="collapse show" id="inProgress2Board">
                                    <div class="form-check mb-2px">
                                        ...
                                        <label class="form-check-label small" for="customCheck6">debug and fix mobile auto close while using GPS issue</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list-group-item d-flex px-3">
                        ...
                        <div class="flex-fill">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div>
                                    <a href="#add" class="text-white text-opacity-50" data-bs-toggle="collapse" data-bs-target="#completedBoard">
                                        <i class="fa fa-plus-circle"></i>
                                    </a>
                                </div>
                                <div class="progress progress-xs w-100px me-2 ms-auto" style="height: 6px;">
                            ...
                            <div class="form-group mb-1">
                                <div class="collapse show" id="completedBoard">
                                    <div class="form-check mb-2px">
                                        ...
                                        <label class="form-check-label small" for="customCheck7">install react-daterangepicker</label>
                                    </div>
                                    <div class="form-check mb-2px">
                                        <input type="checkbox" class="form-check-input" id="customCheck8" checked />
                                        <label class="form-check-label small" for="customCheck8">customize ui with scss</label>
                                    </div>
                                    <div class="form-check mb-2px">
                                        <input type="checkbox" class="form-check-input" id="customCheck9" checked />
                                        <label class="form-check-label small" for="customCheck9">backend integration for data filter with daterange input</label>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="#cancel" class="btn btn-outline-default" data-bs-dismiss="modal">Cancel</a>
                    <button type="button" class="btn btn-outline-theme">Create</button>
                </div>
            </div>
        </div>
    </div>
