...
<div id="content" class="app-content" style="padding-left: 24px;">
    <!-- BEGIN container -->
    <div class="container">
        <!-- BEGIN row -->
                            ...
                            <div class="card">
                                <div class="list-group list-group-flush">
                                    ...
                                    <div class="list-group-item d-flex align-items-center">
                                        <div class="flex-1 text-break">
                                            <div>Firewall</div>
                                            <div class="text-white text-opacity-50 d-block d-xl-flex align-items-center">
                            ...
                            <div class="card">
                                <div class="list-group list-group-flush">
                                    <div class="list-group-item d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="#reset" class="btn btn-outline-default w-100px">Reset</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-arrow">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-muted">
                    ...
                    <a href="#alert" class="alert-link">Learn more.</a>
                </div>
                <div class="mb-3">
                    <label class="form-label" for="others">Other Names</label>
                    <div>
                        <a href="#add" class="btn btn-outline-default"><i class="fa fa-plus fa-fw"></i> Add other names</a>
                    </div>
                </div>
            </div>
