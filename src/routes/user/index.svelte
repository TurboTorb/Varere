                    ...
                    <div class="profile-sidebar">
                        <div class="desktop-sticky-top">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <a href="#follow" class="btn btn-sm btn-outline-theme fs-11px">Follow</a>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                        ...
                                        <div class="tab-pane fade show active" id="profile-post">
                                            <div class="card mb-3">
                                                <div class="card-body">
                                                    <!-- post header -->
                                                    <div class="d-flex align-items-center mb-3">
                                                        <a href="#profile"><img src="/assets/img/user/profile.jpg" alt="" width="50" class="rounded-circle" /></a>
                                                        <div class="flex-fill ps-2">
                                                            <div class="fw-bold"><a href="#user" class="text-decoration-none">Clyde Stanley</a> at <a href="#address" class="text-decoration-none">South Lake Tahoe, California</a></div>
                                                    ...
                                                    <div class="row text-center fw-bold">
                                                        <div class="col">
                                                            <a href="#like" class="text-white text-opacity-50 text-decoration-none d-block p-2">
                                                                <i class="far fa-thumbs-up me-1 d-block d-sm-inline"></i> Likes
                                                            </a>
                                                        </div>
                                                        <div class="col">
                                                            <a href="#comment" class="text-white text-opacity-50 text-decoration-none d-block p-2">
                                                                <i class="far fa-comment me-1 d-block d-sm-inline"></i> Comment
                                                            </a>
                                                        </div>
                                                        <div class="col">
                                                            <a href="#share" class="text-white text-opacity-50 text-decoration-none d-block p-2">
                                                        ...
                                                        <div class="flex-fill ps-2">
                                                            <div class="position-relative d-flex align-items-center">
                                                                ...
                                                                <div class="position-absolute end-0 text-center">
                                                                    <a href="#smile" class="text-white text-opacity-50 me-2"><i class="fa fa-smile"></i></a>
                                                                    <a href="#camera" class="text-white text-opacity-50 me-2"><i class="fa fa-camera"></i></a>
                                                                    <a href="#video" class="text-white text-opacity-50 me-2"><i class="fa fa-video"></i></a>
                                                                    <a href="#paw" class="text-white text-opacity-50 me-3"><i class="fa fa-paw"></i></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        <a href="#profile"><img src="/assets/img/user/profile.jpg" alt="" width="50" class="rounded-circle" /></a>
                                                        <div class="flex-fill ps-2">
                                                            <div class="fw-bold"><a href="#user" class="text-decoration-none">Clyde Stanley</a> is watching <a href="#video" class="text-decoration-none">PATAGONIA 8k</a></div>
                                                    ...
                                                    <div class="ratio ratio-16x9">
                                                        <iframe title="YouTube Link" src="https://www.youtube.com/embed/ChOhcHD8fBA?showinfo=0"></iframe>
                                                    </div>
                                                    <hr class="mb-1" />
                                                    ...
                                                    <div class="row text-center fw-bold">
                                                        <div class="col">
                                                            <a href="#likes" class="text-white text-opacity-50 text-decoration-none d-block p-2">
                                                                <i class="far fa-thumbs-up me-1 d-block d-sm-inline"></i> Likes
                                                            </a>
                                                        </div>
                                                        <div class="col">
                                            ...
                                            <div class="card mb-3">
                                                <div class="card-body">
                                                    <!-- post header -->
                                                    <div class="d-flex align-items-center mb-3">
                                                        <a href="#profile" class="text-decoration-none"><img src="/assets/img/user/profile.jpg" alt="" width="50" class="rounded-circle" /></a>
                                                        <div class="flex-fill ps-2">
                                                            <div class="fw-bold"><a href="#user" class="text-decoration-none">Clyde Stanley</a></div>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center mb-3">
                                                        <a href="#profile"><img src="/assets/img/user/profile.jpg" alt="" width="50" class="rounded-circle" /></a>
                                                        <div class="flex-fill ps-2">
                                                            <div class="fw-bold"><a href="#user" class="text-decoration-none">Clyde Stanley</a> at <a href="#country" class="text-decoration-none">United States</a></div>
                                        ...
                                        <div class="tab-pane fade" id="profile-followers">
                                            <div class="list-group">
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div><a href="#user" class="text-white fw-bold text-decoration-none">Ethel Wilkes</a></div>
                                                        <div class="text-white text-opacity-50 fs-13px">North Raundspic</div>
                                                    </div>
                                                    <a href="#follow" class="btn btn-outline-theme">Follow</a>
                                                </div>
                                                <div class="list-group-item d-flex align-items-center">
                                                    <img src="/assets/img/user/user-2.jpg" alt="" width="50" class="rounded-sm ms-n2" />
                                                    <div class="flex-fill px-3">
                                                        <div><a href="#user" class="text-white fw-bold text-decoration-none">Shanaya Hansen</a></div>
                                                        <div class="text-white text-opacity-50 fs-13px">North Raundspic</div>
                                                    </div>
                                                    <a href="#follow" class="btn btn-outline-theme">Follow</a>
                                                </div>
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div><a href="#user" class="text-white fw-bold text-decoration-none">James Allman</a></div>
                                                        <div class="text-white text-opacity-50 fs-13px">North Raundspic</div>
                                                    </div>
                                                    <a href="#follow" class="btn btn-outline-theme">Follow</a>
                                                </div>
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div><a href="#user" class="text-white fw-bold text-decoration-none">Marie Welsh</a></div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div><a href="#user" class="text-white fw-bold text-decoration-none">Lamar Kirkland</a></div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div><a href="#user" class="text-white fw-bold text-decoration-none">Bentley Osborne</a></div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div><a href="#user" class="text-white fw-bold text-decoration-none">Ollie Goulding</a></div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div><a href="#user" class="text-white fw-bold text-decoration-none">Hiba Calvert</a></div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div><a href="#user" class="text-white fw-bold text-decoration-none">Rivka Redfern</a></div>
                                                ...
                                                <div class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="flex-fill px-3">
                                                        <div><a href="#user" class="text-white fw-bold text-decoration-none">Roshni Fernandez</a></div>
                                                        <div class="text-white text-opacity-50 fs-13px">Mount Lerdo</div>
                                                    </div>
                                                    <a href="#follow" class="btn btn-outline-theme">Follow</a>
                                                </div>
                                            </div>
                                            <div class="text-center p-3"><a href="#more" class="text-white text-decoration-none">Show more <b class="caret"></b></a></div>
                                        </div>
                                        <!-- END tab-pane -->
                                        ...
                                        <div class="card mb-3">
                                            <div class="list-group list-group-flush">
                                                <div class="list-group-item fw-bold px-3 d-flex">
                                                    ...
                                                    <a href="#more" class="text-white text-opacity-50"><i class="fa fa-cog"></i></a>
                                                </div>
                                                <div class="list-group-item px-3">
                                                    ...
                                                    <a href="#trending" class="card text-white text-decoration-none mb-1">
                                                        <div class="card-body">
                                                ...
                                                <div class="list-group-item px-3">
                                                    ...
                                                    <a href="#trending" class="card mb-1 text-white text-decoration-none">
                                                        <div class="card-body">
                                                            <div class="row no-gutters">
                                                                <div class="col-md-8">
                                                ...
                                                <a href="#more" class="list-group-item list-group-action text-center">
                                                    Show more
                                                </a>
                                            </div>
                                            <div class="card-arrow">
