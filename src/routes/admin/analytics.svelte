<script>
    ...
    let scripts = [
        "/assets/js/demo/analytics.demo.js"
    ];
...
<div id="content" class="app-content">
    ...
    <div class="d-flex align-items-center mb-3">
        <a href="#today" class="btn btn-sm btn-outline-theme rounded-0" id="daterangepicker">
    ...
    <div class="row" data-masonry='true'>
        <!-- BEGIN col-4 -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <a href="#report" class="text-decoration-none text-white text-opacity-50">View report</a>
                    </div>
        ...
        <div class="col-lg-6 col-xl-4 mb-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- list -->
                    <div class="row mb-2">
                        <div class="col-6"><div><a href="#promax" class="text-decoration-none text-white text-opacity-50">/phone/apple-11-pro-max</a></div></div>
                        <div class="col-3 text-center">15</div>
                        <div class="col-3 text-center"><span class="text-theme">+</span> 15%</div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-6"><div><a href="#ipad" class="text-decoration-none text-white text-opacity-50">/tablet/apple-ipad-pro-128gb</a></div></div>
                        <div class="col-3 text-center">12</div>
                        <div class="col-3 text-center"><span class="text-theme">+</span> 8%</div>
                    </div>
                    <div class="row">
                        <div class="col-6"><div><a href="#macpro" class="text-decoration-none text-white text-opacity-50">/desktop/apple-mac-pro</a></div></div>
