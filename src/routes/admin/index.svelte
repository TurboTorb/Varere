            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex fw-bold small mb-3">
                        ...
                        <a href="#visitors" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                    </div>
                    <!-- END title -->
                    <!-- BEGIN stat-lg -->
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex fw-bold small mb-3">
                        ...
                        <a href="#sales" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                    </div>
                    <!-- END title -->
                    <!-- BEGIN stat-lg -->
                    <div class="row align-items-center mb-2">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex fw-bold small mb-3">
                        ...
                        <a href="#members" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                    </div>
                    <!-- END title -->
                    <!-- BEGIN stat-lg -->
                    <div class="row align-items-center mb-2">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex fw-bold small mb-3">
                        ...
                        <a href="#bandwidth" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                    </div>
                    <!-- END title -->
                    <!-- BEGIN stat-lg -->
                    <div class="row align-items-center mb-2">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex fw-bold small mb-3">
                        ...
                        <a href="#stats" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                    </div>
                    <!-- END title -->
                    <!-- BEGIN chart -->
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex fw-bold small mb-3">
                        ...
                        <a href="#traffic" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                    </div>
                    <!-- END title -->
                    <!-- BEGIN map -->
                    <div class="ratio ratio-21x9 mb-3">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex fw-bold small mb-3">
                        ...
                        <a href="#products" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                    </div>
                    <!-- END title -->
                    <!-- BEGIN table -->
                        ...
                        <table class="w-100 mb-0 small align-middle text-nowrap">
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="position-relative mb-2">
                                                <div class="bg-center bg-cover bg-no-repeat w-80px h-60px" style="background-image: url(/assets/img/dashboard/product-1.jpeg);">
                                                </div>
                                    ...
                                    <td><a href="#search" class="text-decoration-none text-white"><i class="bi bi-search"></i></a></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="d-flex mb-2 align-items-center">
                                            <div class="position-relative">
                                                <div class="bg-center bg-cover bg-no-repeat w-80px h-60px" style="background-image: url(/assets/img/dashboard/product-2.jpeg);">
                                                </div>
                                                <div class="position-absolute top-0 start-0">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex mb-2 align-items-center">
                                            <div class="position-relative">
                                                <div class="bg-center bg-cover bg-no-repeat w-80px h-60px" style="background-image: url(/assets/img/dashboard/product-3.jpeg);">
                                                </div>
                                                <div class="position-absolute top-0 start-0">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex mb-2 align-items-center">
                                            <div class="position-relative">
                                                <div class="bg-center bg-cover bg-no-repeat w-80px h-60px" style="background-image: url(/assets/img/dashboard/product-4.jpeg);">
                                                </div>
                                                <div class="position-absolute top-0 start-0">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="position-relative">
                                                <div class="bg-center bg-cover bg-no-repeat w-80px h-60px" style="background-image: url(/assets/img/dashboard/product-5.jpeg);">
                                                </div>
                                                <div class="position-absolute top-0 start-0">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex fw-bold small mb-3">
                        ...
                        <a href="#fullscreen" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i class="bi bi-fullscreen"></i></a>
                    </div>
                    <!-- END title -->
                    <!-- BEGIN table -->
                    <div class="table-responsive">
